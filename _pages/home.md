...
The Artificial Intelligence (AIML) group, lead by Prof. Dr. Eirini Ntoutsi, focuses on developing intelligent algorithms that address *real-world challenges*, such as non-stationarity and scarcity, and enable *trustworthy decision-making*.<!--that learn from data *continuously* following the cumulative nature of human learning, while ensuring that what has been learned helps driving *positive societal impact*--> Ongoing directions include:

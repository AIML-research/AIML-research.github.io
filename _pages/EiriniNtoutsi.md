...
#### Recent Talks & Events
<ul>
  <li> Keynote at ECAF (European Conference on Algorithmic Fairness) </a> in Ghent, Belgium on The Tensions and Trade-Offs of Algorithmic Fairness - From Metric Incompatibility to Cross-Pillar Trade-Offs (<a href="/files/26.ECAF.Keynote(final).pdf">slides</a>).

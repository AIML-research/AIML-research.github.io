...
<p>She specializes in developing intelligent algorithms to tackle *real-world challenges* like *non-stationarity*, *imbalances*, and *data scarcity*. Committed to *responsible AI* progress, she focuses on understanding the capabilities and limitations of AI systems by addressing *bias and discrimination*, enhancing transparency through *explainable AI*, and strengthening the *resilience* and *robustness* of AI/ML models.</p>
